    ...
    function printLayout($tax_type)
    {
      if ($tax_type == "income") {
        ...
        echo ('<div class="row mt-3">
                        ...
                        <div class="col-6">
                          <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Income" aria-label="income" aria-describedby="basic-addon1" name="income_value" value="' . number_format($_POST["income_value"], 2) . '" disabled>
                          </div>
                        </div>
                      </div>
            ...
            <div class="row mt-4">
              <div class="card col-12">
                ...
                <h3><b> Your tax breakdown report is as follows: </b></h3>
                  ...
                  <div class="col-6">
                    <p><b>₱' . number_format($_SESSION['PHILHEALTH'], 2) . '</b></p>
                  </div>
                  <div class="col-5">
                    <p> PAGIBIG </p>
                  </div>
                  <div class="col-6">
                    <p><b>₱' . number_format($_SESSION['PAGIBIG'], 2) . '</b></p>
                  </div>
                  <div class="col-5">
                    <p> SSS REGULAR </p>
                  </div>
                  <div class="col-6">
                    <p><b>₱' . number_format($_SESSION['SSS_REGULAR'], 2) . '</b></p>
                  </div>
                  <div class="col-5">
                    <p> SSS MPF </p>
                  </div>
                  <div class="col-6">
                    <p><b>₱' . number_format($_SESSION['SSS_MPF'], 2) . '</b></p>
                  </div>
                  <div class="col-12">
                    <p> Adding this altogether, your <b>non-taxable income</b> amounts to <b>₱' . number_format($_SESSION['NONTAXABLE_INCOME'], 2) . '</b></p>
                  </div>
                  <div class="col-12">
                    <p> After deducting your contributions, your <b>taxable income</b> amounts to <b>₱' . number_format($_SESSION['TAXABLE_INCOME'], 2) . '</b></p>
                  </div>
                  <div class="col-12">
                    <p> This will lead your <b>annual income tax</b> amounting to <b>₱' . number_format($_SESSION['TAX'], 2) . '</b></p>
                  </div>
                  <div class="col-8">
                    <p> And a <b>final take-home amount</b> of <b>₱' . number_format($_SESSION['FINAL_INCOME'], 2) . '</b></p>
                  </div>
                  <div class="col-4">
                    <a style="color: black; font-weight: bold;" href="learnmore_income.php"><i>How was this calculated?</i></a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="card-body row">
                  ...
                  <div class="col-12 card mt-3">
                    ...
                    <div class="row mt-3">
                      ...
                      <div class="col-6">
                        <div class="input-group mb-3">
                          <input type="text" class="form-control" placeholder="CGT Base" aria-label="income" aria-describedby="basic-addon1" name="cgt_value" value= ' . number_format($_POST["cgt_base"], 2) . '>
                        </div>
                      </div>
                    </div>
            ...
            <div class="row mt-4">
              <div class="card col-12">
                ...
                <h3><b> Your tax breakdown report is as follows: </b></h3>
                  ...
                  <div class="col-6">
                    <p><b>₱' . number_format($_POST['cgt_base'], 2) . '</b></p>
                  </div>
                  <div class="col-8">
                    <p> You will be required to pay an amount of <b>₱' . number_format($_SESSION['CGT'], 2) . '</b> in <b>capital gains tax</b> from your sale. </p>
                  </div>
                  <div class="col-4">
                    <a style="color: black; font-weight: bold;" href="learnmore_capitalgains.php"><i>How was this calculated?</i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        echo ('<div class="row mt-3">
                        ...
                        <div class="col-6">
                          <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Income" aria-label="income" aria-describedby="basic-addon1" name="income_value" value="' . number_format($_POST["vat_amount"], 2) . '" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="row justify-content-center">
            ...
            <div class="row mt-4">
              <div class="card col-12">
                ...
                <h3><b> Your tax breakdown report is as follows: </b></h3>
                  ...
                  <div class="col-6">
                    <p><b>₱' . number_format($_SESSION['VAT_GROSS'], 2) . '</b></p>
                  </div>
                  <div class="col-5">
                    <p> Nett Amount </p>
                  </div>
                  <div class="col-6">
                    <p><b>₱' . number_format($_SESSION['VAT_NETT'], 2) . '</b></p>
                  </div>
                  <div class="col-3">
                    <p> VAT </p>
                  </div>
                  <div class="col-3">
                    <p><b>₱' . number_format($_SESSION['VAT'], 2) . '</b></p>
                  </div>
                  <div class="col-4">
                    <a style="color: black; font-weight: bold;" href="learnmore_vat.php"><i>How was this calculated?</i></a>
                  </div>
