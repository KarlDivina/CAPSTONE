  ...
  <div class="row py-2" style="background-color:#ffa500; top: 0;">
    <div class="col-12">
      <ul class="nav nav-underline justify-content-center">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="homepage.php" style="font-weight: bold; color: white;">Compute your tax</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="login system\login_form.php" style="font-weight: bold; color: white;">Login</a>
        </li>
      </ul>
    </div>
  </div>
                        ...
                        <div class="col-2">
                          <div class="input-group mb-3">
                            <input 
                              ...
                              value="Submit" 
                              name="compute_tax"
                              onclick="checkIncomeInput(event)"
                            >
                          </div>
                        </div>
                        <script>
                        <script>
function checkIncomeInput(event) {
  var incomeValue = document.getElementById("income_value").value;
  if (incomeValue.trim() === "") {
    event.preventDefault();
    document.getElementById("income_warning").style.display = "block";
  }
}
</script>
                      </div>
  ...
  echo "$('#tax_type').autoNumeric('init');";
  echo ' });';
  echo '</script>';
  ?>
